...
router.get("/", asyncHandler(async(req,res)=>{
    ...
    const bestEntry = analyses.reduce((best, a)=> a.atsScore > best.atsScore ? a: best);
    ...
    const topIssues = topN(allIssues, 
    ...
    const resumePerformance = resumes.map((r)=> {
        const ras = analyses.filter((a)=> a.resumeId.toString() === r._id.toString());
