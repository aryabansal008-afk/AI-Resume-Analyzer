...
const responseSchema = {
    ...
    properties: {
        atsScore: {
            type: Type.NUMBER,
            description: "ATS readiness score from 0 to 100",}, //gemini reads description as hints
            scoreBreakdown: {
                type: Type.OBJECT,
        ...
        issues:{
            ...
            items: {
                type: Type.OBJECT,
                required: ["title","severity","explaination","fix"],
                properties: {
                    title: {type: Type.STRING},
                    severity: {type: Type.STRING, enum:["low","medium","high"]},
                    explaination: {type: Type.STRING},
        ...
        bulletRewrites: {
            type: Type.ARRAY,
            description: "5-10 weak bullets rewritten to be strongeer and ATS friendly",
            items: {
                type: Type.OBJECT,
...
const analysisValidator = z.object({
    ...
    strengths: z.array(z.object({title: z.string(),
        evidence: z.string()
    })).min(1),
